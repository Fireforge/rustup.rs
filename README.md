...
Studio 2013 (or later) or the Microsoft Visual C++ Build Tools 2015][vs]
so rustc can use its linker. For Visual Studio, make sure to check
...
Visual Studio 2015 or the Microsoft Visual C++ Build Tools 2015][vs].
For Visual Studio, make sure to check the "C++ tools" option. No
additional software installation is necessary for basic use of the
GNU build.
